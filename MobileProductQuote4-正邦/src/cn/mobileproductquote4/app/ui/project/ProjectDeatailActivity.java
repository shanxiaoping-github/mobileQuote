...
import cn.mobileproductquote4.app.adapter.ProductAdapter;
import cn.mobileproductquote4.app.data.Product;
import cn.mobileproductquote4.app.data.Project;
import cn.mobileproductquote4.app.data.Product.QuoteProduct;
import cn.mobileproductquote4.app.http.BaseAsynHttpClient;
import cn.mobileproductquote4.app.http.HttpComparisonOprate;
import cn.mobileproductquote4.app.http.HttpComparisonQuote;
import cn.mobileproductquote4.app.http.HttpMethod;
import cn.mobileproductquote4.app.http.HttpProducts;
import cn.mobileproductquote4.app.http.HttpProjectQuote;
import cn.mobileproductquote4.app.http.BaseAsynHttpClient.AsynHcResponseListener;
...
import cn.mobileproductquote4.app.util.ShowUtil;
import cn.mobileproductquote4.app.util.Time;
		...
		Dialog dialog = new AlertDialog.Builder(this)
				...
				.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface arg0, int arg1) {
						...
						if (!MathUtil.isDoubleNumber(price, 0, Double.MAX_VALUE,
								true, true)) {// 非法的数值
							showShortToast("请输入正确的数值");

						} else if (!isMaxLast(Double.valueOf(price),
								product.getLastPrice())) {
							showShortToast("产品单价不能高于上一次报价");
						} else {

							product.setCurrentPrice(Double.parseDouble(price));
							productAdapter.notifyDataSetChanged();
