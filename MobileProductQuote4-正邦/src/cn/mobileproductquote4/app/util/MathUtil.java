package cn.mobileproductquote4.app.util;
...
public class MathUtil {
	 ...
	 * @return
	 */
	public static boolean isDoubleNumber(String numberStr,double startNumber,double endNumber,boolean havaStart,boolean havaEnd) {
		try {
